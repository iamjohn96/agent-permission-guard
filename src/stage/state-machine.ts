...
const NEXT_STATES: Readonly<Record<PackageStageState, readonly PackageStageState[]>> = Object.freeze({
  ...
  ARTIFACTS_VERIFIED: ['PASS_A_RUNNING', 'ARCHIVES_PREFLIGHTED', 'FAILED_QUARANTINE'],
  PASS_A_RUNNING: ['ARCHIVES_PREFLIGHTED', 'FAILED_QUARANTINE'],
  ARCHIVES_PREFLIGHTED: ['PASS_B_RUNNING', 'MATERIALIZING', 'FAILED_QUARANTINE'],
  PASS_B_RUNNING: ['MATERIALIZING', 'FAILED_QUARANTINE'],
  MATERIALIZING: ['TREE_VERIFIED', 'FAILED_QUARANTINE'],
  TREE_VERIFIED: ['READY_TO_COMMIT', 'FAILED_QUARANTINE'],
  READY_TO_COMMIT: ['SEALED_PENDING_AUDIT', 'READY', 'FAILED_QUARANTINE'],
  SEALED_PENDING_AUDIT: ['READY', 'FAILED_QUARANTINE'],
